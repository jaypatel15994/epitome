									...
									<div class="product_content">
										<div
											...
											<div class="ml-auto text-right">
												<div class="rating_r rating_r_4 home_item_rating">
													<i></i><i></i><i></i><i></i><i></i></div>
												<div class="product_price text-right">$1<span>.99</span></div>
											</div>
										</div>
										<div class="product_buttons">
											<div
						...
						<div class="row">
							<div class="col">
								<div
									...
									<!-- Box 1-->
									<div class="box">
										<div class="background_image" style="background-image:url({{asset('assets/images/box_1.jpg')}})">
										</div>
										<div
												...
												<div class="box_image">
													<a href="seller.html">
														<div class="background_image"
															style="background-image:url({{asset('assets/images/box_1_img.jpg')}})"></div>
													</a>
												</div>
											</div>
									...
									<!-- Box 2-->
									<div class="box">
										<div class="background_image" style="background-image:url({{asset('assets/images/box_2.jpg')}})">
										</div>
										<div
											class="box_content d-flex flex-row align-items-center justify-content-start">
											<div class="box_left">
												<div class="box_image">
													<a href="seller.html">
														<div class="background_image"
															style="background-image:url({{asset('assets/images/box_2_img.jpg')}})"></div>
													</a>
												</div>
											</div>
											<div class="box_right text-center">
									...
									<!-- Box 3-->
									<div class="box">
										<div class="background_image" style="background-image:url({{asset('assets/images/box_3.jpg')}})">
										</div>
										<div
											class="box_content d-flex flex-row align-items-center justify-content-start">
											<div class="box_left">
												<div class="box_image">
													<a href="seller.html">
														<div class="background_image"
															style="background-image:url({{asset('assets/images/box_3_img.jpg')}})"></div>
													</a>
												</div>
											</div>
											<div class="box_right text-center">
								...
								<div class="col-lg-4 footer_col">
									<div class="footer_about">
										<div class="footer_logo">
											<a href="#">
												<div class="d-flex flex-row align-items-center justify-content-start">
													<div class="footer_logo_icon"><img src="images/logo_2.png" alt="">
													</div>
													<div>Epitome</div>
												</div>
											</a>
